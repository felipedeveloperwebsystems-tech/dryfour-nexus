...
const EduContentModule = {
  async load(subject, group, topic) {
    ...
    if (bodyEl) {
      ...
      // Inicializa módulos interativos se o tópico tiver simuladores.
      // JS declarado no aprender.js (MathSimulatorModule) em vez de inline
      // no content — garante execução 100% após o innerHTML estar no DOM.
...
/* ================================================================
   ...
   As 4 engines de cálculo do tópico "Operações".
   Código extraído 1:1 do content — movido para cá para
   garantir execução após innerHTML estar no DOM.
